...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://massagegunpicks.com/${article.slug}` },
    openGraph: {
      title: article.title,
      description: article.description,
      url: `https://massagegunpicks.com/${article.slug}`,
      type: "article",
  ...
  const articleSchema =
    article.articleSchema ??
    {
      ...
      publisher: {
        ...
        logo: { "@type": "ImageObject", url: "https://massagegunpicks.com/icon.svg" },
      },
      datePublished: article.date,
      dateModified: article.dateModified,
      mainEntityOfPage: { "@type": "WebPage", "@id": `https://massagegunpicks.com/${article.slug}` },
    };
